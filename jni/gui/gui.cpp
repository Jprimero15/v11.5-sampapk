...
const auto encVersion = cryptor::create("1.0.3.11.5", 37);
...
CGUI::CGUI()
{
	...
	style.Colors[ImGuiCol_ButtonHovered] = ImVec4(0.2f, 0.2f, 0.2f, 0.2f);
	style.Colors[ImGuiCol_ButtonActive] = PRIMARY_COLOR;
	
	style.Colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.2f, 0.2f, 0.2f, 0.2f);
...
void CGUI::RenderVersion()
{
	...
	RenderText(verpos, ImColor(0xFFFFFFFF), true, encVersion.decrypt());
}
